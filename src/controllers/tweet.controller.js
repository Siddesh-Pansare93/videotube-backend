    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to create Tweet due to ${error.message}`
        )
      );
  }
});
...
const getUserTweets = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json(new ApiResponse.success(userTweets, "User tweets found"));
  } catch (error) {
    return res
      .status(500)
      .json(
        new ApiResponse(
          500,
          null,
          `Error in finding User Tweets due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to Update Tweet due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to delete Tweet due to ${error.message}`
        )
      );
  }
});
