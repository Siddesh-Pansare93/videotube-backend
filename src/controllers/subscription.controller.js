    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to toggle subscription due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to get subscribers due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to fetch User Subscribed Channels due to ${error.message}`
        )
      );
  }
});
