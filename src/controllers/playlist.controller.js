    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to create Playlist due to ${error.message} ! Please try again`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to get User Playlist due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to get Playlist due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to add Video to playlist due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to remove Video from Playlist due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to delete Playlist due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to update Playlist due to ${error.message}`
        )
      );
  }
});
