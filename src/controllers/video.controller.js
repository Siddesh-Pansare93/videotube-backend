    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to publish a video due to ${error.message} ! Please try again`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to Update Video Details due to ${error.message} : Please Try again after sometime`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to delete Video due to ${error.message}`
        )
      );
  }
});
    ...
    return res
      ...
      .json(
        new ApiResponse(
          500,
          null,
          `Failed to toggle Publish Status due to ${error.message}`
        )
      );
  }
});
